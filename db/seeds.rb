...
Dish.create ({name: "lumberjack breakfast", course: "breakfast", description: "like eggs and potatoes and bacon and stuff", price: 11})
Dish.create ({name: "waffles", course: "breakfast", description: "a big fluffy waffle with real maple syrup", price: 10})
Dish.create ({name: "hamburger", course: "lunch", description: "cooked with a flamethrower.  also it has onions.", price: 12})
Dish.create ({name: "panino", course: "lunch", description: "with meat and cheese and stuff.", price: 12})
Dish.create ({name: "pasta fagioli", course: "lunch", description: "the best italian soup.", price: 8})
Dish.create ({name: "roast duck", course: "dinner", description: "a big one", price: 25})
Dish.create ({name: "spaghetti alle vongole", course: "dinner", description: "creamy pasta with clams", price: 15})
Dish.create ({name: "buccatini all'amatriciana", course: "dinner", description: "pasta with bacony tomato sauce", price: 15})
Dish.create ({name: "fried brussels sprouts", course: "sides", description: "oh my god i love brussels sprouts", price: 10})
Dish.create ({name: "kale salad", course: "sides", description: "because I live in brooklyn", price: 10})
...
Ingredient.create ({name: "celery", description: "basically hard green water", vegetarian: 2 })
